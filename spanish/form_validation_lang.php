...
$lang['alpha_numeric'] = 'El campo %s debe contener solo números y letras';
$lang['alpha_dash'] = 'El campo %s debe contener solo números y guiones bajos _';
$lang['numeric'] = 'El campo %s debe contener solo números';
$lang['is_numeric'] = 'El campo %s debe contener solo números';
$lang['integer'] = 'El campo %s debe contener un números enteros';
$lang['matches'] = 'El campo %s no coincide con el campo %s';
$lang['is_natural'] = 'El campo %s debe contener solo números reales';
$lang['is_natural_no_zero'] = 'El campo %s debe contener un número distinto de cero';
?>